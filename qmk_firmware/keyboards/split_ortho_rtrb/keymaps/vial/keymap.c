...
[_BASE] = LAYOUT_SPLITORTHO(
        ...
        KC_LCTRL,MO(_L3_NUM),KC_LGUI,KC_LALT,MO(_L1_NAV),KC_SPC,
        
        // 右手側
                KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS,
                KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_ENT,
                KC_H,    KC_J,    KC_K,    TD(0),   TD(1),   KC_QUOT, // TD(0), TD(1) はVial GUIで設定
        KC_BSLS,KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,
        KC_BSPC, KC_DEL,  MO(_L2_FUNC) // MO(2) はVial GUIで設定
    ),
